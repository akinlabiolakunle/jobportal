                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="page_listing">
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img1.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Team of PHP MySQL Developers<p>Agricultural Sceences</p> </h1>
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img2.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Urgent Opening for PHP Developer<p>Agricultural Sceences</p> </h1>
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img3.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Urgent Require- Web Developer<p>Agricultural Sceences</p> </h1>
                                                    <div class="work-time part text-center col-md-2">Part Time</div>
                                               </div>
                                            <div class="bottom_text">
                                                <div class="contact_details col-md-4 col-sm-4">
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img4.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Nodejs,Angularjs Developer<p>Agricultural Sceences</p> </h1>
                                                    <div class="work-time text-center col-md-2">Full Time</div>
                                               </div>
                                            <div class="bottom_text">
                                                <div class="contact_details col-md-4 col-sm-4">
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img5.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Software Developer -IT Co<p>Agricultural Sceences</p> </h1>
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img6.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Website Developer and Head of Developers<p>Agricultural Sceences</p> </h1>
                                                    <div class="work-time text-center col-md-2">Full Time</div>
                                               </div>
                                            <div class="bottom_text">
                                                <div class="contact_details col-md-4 col-sm-4">
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img7.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Software Developer-Winforms-wpf<p>Agricultural Sceences</p> </h1>
                                                    <div class="work-time text-center col-md-2">Full Time</div>
                                               </div>
                                            <div class="bottom_text">
                                                <div class="contact_details col-md-4 col-sm-4">
                                        ...
                                        <div class="sorting_content">
                                           <div class="tab-image"><img src="../assets/images/home/img7.jpg" alt="" class="img-responsive"></div>
                                            <div class="overflow">
                                               <div class="text-shorting">
                                                   <h1 class="col-md-6 col-sm-7">Software Developer -Leading IT Company<p>Agricultural Sceences</p> </h1>
                                                    <div class="work-time part text-center col-md-2">part Time</div>
                                               </div>
                                            <div class="bottom_text">
                                                <div class="contact_details col-md-4 col-sm-4">
