                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="page_listing candidate">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-2.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>Rachael Smith</h1>
                                        <ul class="unstyled">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-4.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>Angela Haze</h1>
                                        <ul class="unstyled">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-5.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>Suzy Biggs</h1>
                                        <ul class="unstyled">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-6.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>Homer Simpson</h1>
                                        <ul class="unstyled">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-7.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>Rachael Smith</h1>
                                        <ul class="unstyled">
                            ...
                            <div class="sorting_content">
                                <div class="tab-image"><img src="assets/images/candidates/candidate-8.png" alt="" class="img-responsive"></div>
                                <div class="overflow">
                                    <div class="text-shorting">
                                        <h1>John Spectre</h1>
                                        <ul class="unstyled">
